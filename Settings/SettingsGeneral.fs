...
module SettingsGeneral =  
    ...
    let internal logFileName3 = @"/storage/emulated/0/Logs/tp_canopy_difference.json"
    let internal logDirTP_Canopy = @"/storage/emulated/0/Logs/tp_canopy_difference.json"
