        ...
        IO (fun () 
                ...
                let stateReducer token (state : State) (action : Actions) =
                    ...
                    | CopyOldTimetables 
                        ...
                        | ex 
                            -> 
                            runIO (postToLog2 <| string ex.Message <| "#0081-MDPO")
                    ...
                    | CreateFolders         
                        ...
                        | ex 
                            -> 
                            runIO (postToLog2 <| string ex.Message <| "#0001-MDPO")
                    ...
                    | FilterDownloadSave   
                            ...
                            result 
                                {
                                    ...
                                    let filter = filterTimetables firstSubDir token
                        
                                    return! runIO <| downloadAndSaveTimetables reportProgress token firstSubDir filter
                                }
                        ...
                        | :? DirectoryNotFoundException as ex 
                            ->
                            runIO (postToLog2 <| string ex.Message <| "#0002-MDPO")
