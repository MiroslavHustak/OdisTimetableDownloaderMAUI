...
Zatím mám "stahovač" v konzolové podobě https://github.com/MiroslavHustak/OdisTimetableDownloader a velmi primitivní "androidní" podobě v tomto repozitáři https://github.com/MiroslavHustak/OdisTimetableDownloaderMAUI/blob/master/App.fs (jen předběžně upraveno z konzolové verze (s vykomentovaným error handling, logs, atd.), abych se přesvědčil, že to na mobilu funguje). 
...
Já osobně nemám talent pro UX/UI a z tohoto důvodu ani žádné velké nadšení pro FE. A ani jsem nic "mobilního" ještě nevyvíjel. Ale s Elmishem (to je to, co vidíte v App.fs) pomohu, co budu moci, už jsem v tom programoval. A samozřejme pomohu s F# obecně.
