                        ...
                        {                           
                            ...
                            let l = context.list |> List.length
                                ...
                                let counterAndProgressBar =
                                    MailboxProcessor<MsgIncrement>.StartImmediate
                                        (fun inbox
                                            ->
                                            // Register cancellation → causes Receive() to unblock
                                            use _ =
                                                token.Register
                                                    (fun () 
                                                        ->
                                                ...
                                                async 
                                                    {
                                                        ...
                                                        | ex
                                                            ->
                                                            runIO (postToLog <| ex.Message <| "#904-MP")
                                                            return ()
                                                    }
                                            loop 0
                                        )
                            ...
                            return     
                                            ...
                                            try
                                                ...
                                                let pathToFileExistFirstCheck = // bez tohoto file checking mobilni app nefunguje, TOCTOU race zatim nebyl problem
                                                    ...
                                                    | Some _
                                                        ...
                                                        use response = get >> Request.sendAsync >> (fun a -> Async.RunSynchronously(a, cancellationToken = token)) <| uri 
                                ...
                                | ex                             
                                    ...
                                    | false 
                                        ->
                                        runIO (postToLog <| string ex.Message <| "#024-5")
                                        [ Error <| PdfError FileDownloadError ]
